...
namespace AppVentus\AviaryBundle\Handler;

use AppVentus\AviaryBundle\Twig\Extension\PicturePathExtension;
 ...
 *
 * ref: appventus.aviary.upload_handler
 */
class UploadHandler
{

    protected $options;
    protected $picturePathExtension;
    ...
    public function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file->base64 = $this->picturePathExtension->convertToBase64($file_path);
            $file->id = uniqid();
            $this->set_additional_file_properties($file);
        }
